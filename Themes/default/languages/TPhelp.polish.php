 ...
 *
 * @polskie t逝maczenie Nolt
 */

// Navigation
// Rev 89
$txt['tphelp_introduction']= 'O TP.';
$txt['tphelp_articles']= 'Artyku造';
$txt['tphelp_frontpage']= 'Strona g堯wna';
$txt['tphelp_panels']= 'Panele';
$txt['tphelp_blocks']= 'Bloki';
$txt['tphelp_modules']= 'Modu造';
$txt['tphelp_plugins']= 'Pluginy';

// Page Information... //
// Rev 89
$txt['tphelp_introduction_main']= '
<h2 class="tphelp">&nbsp; Wst瘼 do TinyPortal</h2>
<p class="tphelp">
...
<p class="tphelp">- <b class="tphelp">Artyku造</b>: are HTML, PHP, BBC, imported or external pages with optional author information and visual options to show alone, with panels & blocks, and/or with other articles. All articles can be categorized, or have comments and ratings.</p>
<p class="tphelp">- <b class="tphelp">Strona g堯wna</b>: is the first page or index page of your TP & SMF site. TP gives you ability to dress up your frontpage any way you see fit using forum posts, articles, panels & blocks, and even modules. If you\'re not interested in all that, you can choose for your frontpage to go directly to your forum index. </p>
<p class="tphelp">- <b class="tphelp">Panele</b>: are several sections or containers that hold all of your blocks. There is the top panel, upper panel, frontpanel, lower panel, bottom panel, left panel, and right panel. These panels help control the layout of your TP & SMF driven forum.</p>
<p class="tphelp">- <b class="tphelp">Bloki</b>: these are small boxes of information or functions in HTML, PHP, or BBC. They can be placed in any order, in any panel and section/action of the TP & SMF driven site.</p>
<p class="tphelp">- <b class="tphelp">Mened瞠r menu</b>: A built-in Menu Manager allows you to create multiple menu\'s. These menu\'s are displayed in a block. You get all the features of blocks to display these menu\'s in different places along with choosing who gets to see the blocks based on permissions. You can create different types of links: links to articles, categories, or even just a custom link. You can choose to have the link open in the current window or a new window.</p>
<p class="tphelp">- <b class="tphelp">Modu造</b>: are enhancements to TinyPortal written by various developers that add new abilities to the overall functions of the site. Examples of a module would be: File Manager, Gallery Manager, and Chat.</p>
<p class="tphelp">- <b class="tphelp">Mened瞠r plik闚</b>: A built-in module for TP that lets you offer files for your members to browse and download. Its works by having the downloadable files placed in categories. These categories have permissions on them, letting you restrict member groups access level per each category. You may also allow members to upload files, controlling which membergroups are allowed and what types of files they may upload.</p>
...
<h2 class="tphelp">&nbsp; Strona g堯wna</h2>
<b class="tphelp">Admin</b>:
...
<div class="information" style="margin-top: 1em; padding: 2ex;">This is a summary. For the complete documentation, please browse our <a href="https://www.tinyportal.net/docs/index.php?cat=93" target="_blank"><b class="tphelp">Block Documentation</b></a>.
</div>
...
$txt['tphelp_modules_main']= '<h2 class="tphelp">&nbsp; Modu造</h2>
...
<p class="tphelp">If you wish to add more modules, you can upload them at: <i>TinyPortal > Settings > Modules</i>". TinyPortal carries its own package manager for modules, and this wil help add greater protection to your SMF powered forum. You will also notice here the option to install a module, remove a module, and its statistics such as: version, version compatible with, author, etc etc...</p>
...
<div class="information" style="margin-top: 1em; padding: 2ex;">This is a summary. For the complete documentation, please browse our <a href="https://www.tinyportal.net/docs/index.php?cat=96" target="_blank"><b class="tphelp">Module Documentation</b></a>.
</div>
...
<br><br>
<h4>T逝maczenie na j瞛yk polski</h4>
<a href="https://www.wizzi.pl" title="www.wizzi.pl" target="_blank">Nolt</a>';
...
$txt['tp-credits'] = 'TinyPortal 1.6.1 - Credits';
?>